...
## 4. Disciplina em um sistema acadêmico
- Modele uma classe para representar uma disciplina de graduação em um sistema acadêmico.
- Quais são os atributos e métodos essenciais para essa disciplina?
